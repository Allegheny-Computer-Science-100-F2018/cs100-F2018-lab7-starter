...
# cs100-F2018-lab7-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 7 in Computer Science 100. Since
...
This assignment requires programmer to test, debug, and enhance a Java program,
called `CommandLineGeometer`, that will produce textual output demonstrating the
calculation of different geometric values. First, the program will display the
name of the programmer and the date at which the program was run. Then, it will
read in values from a file and perform calculations and, finally, produce output
...
Java Style Guide](https://google.github.io/styleguide/javaguide.html). Please
note that there are defects in the `CommandLineGeometer` and the
`GeometricCalculator`. You should work to find and fix all of these defects!

The programmer are also responsible for writing a two-paragraph reflection,
...
the geometric values. This is a Markdown file that must adhere to the standards
...
this laboratory assignment, the first paragraph should explain the challenges
that you faced when completing this assignment. Then, the second paragraph
should explain each of the defects that you found and the ways in which you
fixed them.
...
Date()` construct in the Java code. The remainder of the checks are outlined
later in this assignment sheet
...
If you have not done so already, please read the relevant [GitHub
...
Sections 3.1 through 3.8. To enhance your understanding of some concepts in this
laboratory assignment, such as parameter passing, you should also examines
Figures 4.7 and 4.8. Please see the course instructor or one of the teaching
...
program's source code if it is a correct program) the program by using the
command `gradle build`. There are also additional commands that you can type:
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-lab7-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-lab7-starter)
